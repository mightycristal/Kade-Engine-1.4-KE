...
class TitleState extends MusicBeatState
{
			...
			new FlxTimer().start(2, function(tmr:FlxTimer)
			{
				...
				http.onData = function (data:String)
				{
					...
					returnedData[1] = data.substring(data.indexOf('-'), data.length);
				  	if (!MainMenuState.crystalEngineVer.contains(returnedData[0].trim()) && MainMenuState.nightly == "")
					{
	...
	override function beatHit()
	{
		...
		{
			case 1:
				createCoolText(['Mighty', 'B0YFR1END']);
				addMoreText('and the entire mighty crew');
			...
			case 5:
				...
				createCoolText(['Crystal Engine', 'By']);

			case 7:
				addMoreText('Cool Coders');
				ngSpr.visible = true;
			...
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('Vs Mighty'); // credTextShit.text += '\nFunkin';
				case 16:
					skipIntro();
		}
	}
