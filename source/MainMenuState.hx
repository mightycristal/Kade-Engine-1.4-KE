...
class MainMenuState extends MusicBeatState
{
	...
	public static var crystalEngineVer:String = "2.0" + nightly;
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 30, 0, gameVer +  (Main.watermarks ? " Crystal Engine " + crystalEngineVer + "" : ""), 20);
	...
	function goToState()
	{
		...
		switch (daChoice)
		{
			...
			case 'quit':
				//System.exit(0);
				FlxG.switchState(new SpammingSubState());
			case 'bonus':
				FlxG.switchState(new FreeplayState());
				trace("extras");
